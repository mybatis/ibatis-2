...
public interface SqlMapExecutor {
   ...
   * @return The primary key of the newly inserted row. This might be automatically generated by the RDBMS, or selected
   *         from a sequence table or other source.
   ...
   * @return The single result object as supplied by the resultObject parameter, populated with the result set data, or
  ...
  /**
   * Starts a batch in which update statements will be cached before being sent to the database all at once. This can
   * improve overall performance of updates update when dealing with numerous updates (e.g. inserting 1:M related data).
   *
   * @throws java.sql.SQLException
   ...
   * @throws java.sql.SQLException
   *           If the batch could not be executed or if any of the statements fails.
   */
   ...
   * Executes (flushes) all statements currently batched.
   *
   * @return a List of BatchResult objects. There will be one element in the list for each sub-batch executed. A
   *         sub-batch is created by adding a statement to the batch that does not equal the prior statement.
   * @throws SQLException
